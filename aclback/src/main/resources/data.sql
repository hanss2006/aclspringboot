...
ALTER TABLE
  form_asfp
ADD
  CONSTRAINT FK_dict_rate_asfp_id_dict_rate_asfp FOREIGN KEY (dict_rate_asfp_id) REFERENCES dict_rate_asfp;

ALTER TABLE
  form_asfp
ADD
  CONSTRAINT FK_dict_org_unit_id_dict_org_unit FOREIGN KEY (dict_org_unit_id) REFERENCES dict_org_unit;
